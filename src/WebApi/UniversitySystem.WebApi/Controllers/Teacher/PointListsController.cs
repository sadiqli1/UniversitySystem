...
namespace UniversitySystem.WebApi.Controllers.Teacher
{
    ...
    public class PointListsController : ControllerBase
    {
        ...
        [HttpPut("sdf1")]
        public async Task<IActionResult> SDF1Create(int studentId, int lessonId, string teacherUsername, PointPostDto dto)
        {
            SDF1CreateCommand command = new SDF1CreateCommand() {StudentId = studentId, LessonId = lessonId, TeacherUsername = teacherUsername, Point = dto.Point};
