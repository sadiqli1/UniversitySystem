...
{
    public class TSICreateCommandHandler : IRequestHandler<TSICreateCommand, int>
    {
        private readonly IUnitOfWork _unit;
        private readonly UserManager<Person> _usermanager;

        public TSICreateCommandHandler(IUnitOfWork unit, UserManager<Person> userManager)
        {
            _unit = unit;
            _usermanager = userManager;
        }
        public async Task<int> Handle(TSICreateCommand request, CancellationToken cancellationToken)
        {
